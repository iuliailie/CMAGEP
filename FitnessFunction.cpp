...
double FitnessFunction::BoundedFitnessFunction()
{
    double mean=0;
    double fitness;
    double rss=0;
...
double FitnessFunction::BoundedFitnessFunctionWithoutSE()
{
    double mean=0;
    double fitness;
    double rss=0;
...
double FitnessFunction::ComputeFitness()
{
    ...
    case AICx:
        ...
        break;
    case bFF:
        return fitness=BoundedFitnessFunction();
        break;
    case bFFNoSE:
        return fitness=BoundedFitnessFunctionWithoutSE();
        break;
