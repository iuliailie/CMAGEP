...
enum FitnessType {NOH=0,rMSE=1,RSRE=2,rRAE=3,ME=4,AIC=5,CM=6,AICx=7,sOS=8,bFF=9,bFFNoSE=10};
...
public:
    ...
    double xAkaikeIndex();
    double BoundedFitnessFunction();
    double BoundedFitnessFunctionWithoutSE();
    FitnessFunction();
